...
globalkeys = my_table.join(
  ...
  -- super + ... function keys
  awful.key({ modkey }, "F1", function () awful.util.spawn( "meld" ) end,
    {description = "meld" , group = "function keys" }),
  awful.key({ modkey }, "F2", function () awful.util.spawn( "vlc --video-on-top" ) end,
  ...
  awful.key({ modkey }, "F5", function () awful.util.spawn( mediaplayer ) end,
  ...
  -- Brightness
  awful.key({ }, "XF86MonBrightnessUp", function () os.execute("xbacklight +10 -steps 5") end,
    {description = "+10%", group = "hotkeys"}),
  awful.key({ }, "XF86MonBrightnessDown", function () os.execute("xbacklight -10 -steps 5") end,
    {description = "-10%", group = "hotkeys"}),
