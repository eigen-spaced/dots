...
myLayoutHook = spacingRaw True (Border 0 5 5 5) True (Border 5 5 5 5) True $ gaps [(U,35), (D,5), (R,5), (L,5)]
               ...
               $ smartBorders
               $ tiled ||| Grid ||| spiral (6/7) ||| ThreeColMid 1 (3/100) (1/2) ||| noBorders Full ||| Mag.magnifier (Tall 1 (3/100) (1/2))
                    where
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  , ((modMask, xK_equal),                       sendMessage Mag.MagnifyMore)
  , ((modMask, xK_minus),                       sendMessage Mag.MagnifyLess)
  ...
  -- Commented out after replacing xbacklight with acpilight
  -- https://gitlab.com/wavexx/acpilight
  -- Increase brightness
  -- , ((0, xF86XK_MonBrightnessUp),     spawn $ "xbacklight -inc 5")
  , ((0, xF86XK_MonBrightnessUp),     spawn $ "xbacklight +5 -steps 5")

  -- Decrease brightness
  -- , ((0, xF86XK_MonBrightnessDown),   spawn $ "xbacklight -dev 5")
  , ((0, xF86XK_MonBrightnessDown),   spawn $ "xbacklight -5 -steps 5")
...
--  , ((0, xF86XK_AudioStop), spawn $ "mpc stop")
  ...
  , ((controlMask .|. shiftMask , xK_b), withFocused $ windows . W.sink)
...
main = do
    ...
    xmonad $ ewmh $ mydefaults {
        logHook =  dynamicLogWithPP $ xmobarPP
            { ppOutput          = \x -> hPutStrLn xmproc0 x  -- >> IO.hPutStrLn xmproc1 x
            ...
            , ppLayout = (\ x -> case x of
              ...
              "Spacing Magnifier Tall"       -> "<fn=1>: Magnifier </fn>"
              _                                         -> x )
            }
    }
